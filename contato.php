                    ...
                    <div class="info-container">
                        <?php if (!empty(CONF_SITE_STREET_1)) : ?>
                            <div class="contact-info">
                                <span class="icon"><i class="icon-solid icon-house"></i></span>
                        ...
                        <?php if (!empty(CONF_SITE_PHONE)) : ?>
                            <div class="contact-info">
                                <span class="icon"><i class="icon-solid icon-mobile-screen-button"></i></span>
                                <div class="media-body">
                        ...
                        <?php if (!empty(CONF_SITE_EMAIL)) : ?>
                            <div class="contact-info">
                                <span class="icon"><i class="icon-solid icon-envelope-circle-check"></i></span>
                                <div class="media-body">
