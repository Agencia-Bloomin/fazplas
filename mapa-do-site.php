        ...
        <div class="container pt-5 pb-5">
            <div class="row">
                <div class="col-12 col-md-6">
                    ...
                    foreach ($nameUrl as $v) {
                        ...
                        if ($v != "mapa-do-site.php" && $v != "index.php" && $v != "obrigado.php" && $v != "whats-flutuante.php" && $v != "lgpd.php" && $v != "contato_envia.php" &&  $v != "pg-seo.php") {
                            if ($v == "pagina-interna1.php" || $v == "pagina-interna-2") {
                                $page .= '<li> <i class="fas icon-link"></i> <a href="produtos/' . $linkName . '">' . $listName . '</a></li>';
                            } else {
                                $page .= '<li> <i class="fas icon-link"></i> <a href="' . $linkName . '">' . $listName . '</a></li>';
                            }
                        }
                    }
                    ?>
                    ...
                    <ul>
                        <li><i class="fas icon-link"></i> <a href="./"> Bem-vindo à <?php echo CONF_SITE_NAME; ?></a></li>
                        <?= $page ?>
                ...
                <div class="col-12 col-md-6">
                    <ul>
                        <?php foreach($pages as $page):?>
                            <li><i class="fas icon-link"></i> <a href="informacoes/<?=$page->url?>"><?=$page->name;?></a> </li>
                        <?php endforeach;?>
                    </ul>
                </div>
            </div>
