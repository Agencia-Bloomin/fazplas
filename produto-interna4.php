        ...
        <div class="row justify-content-center">
          <div class="col-lg-12">
            <div class="hero-cap text-center ajust-padding">
              ...
              <p class="color-w"><a class="ajust-link" href="./" title="Ir ao início">Home</a> |<a class="ajust-link"
        ...
        <div class="row">
          <div class="col-lg-6 col-md-6">
            <div class="service-details-card">
              <div class="icon">
                <i class="icon-solid icon-check"></i>
              </div>
              <div class="details">
      ...
      <div class="sticky-div">
        <div class="sedebar02">
          <div class="box-categoria">
            ...
            <ul>
              <li><a href="#"><span>Kitchen Plumbing</span><i class="icon-solid icon-arrow-right-long"></i></a></li>
              <li><a href="#"><span>Gas Line Services</span><i class="icon-solid icon-arrow-right-long"></i></a></li>
              <li><a href="#"><span>Water Line Repair</span><i class="icon-solid icon-arrow-right-long"></i></a></li>
              <li><a href="#"><span>Bathroom Plumbing</span><i class="icon-solid icon-arrow-right-long"></i></a></li>
              <li><a href="#"><span>Basement Plumbing</span><i class="icon-solid icon-arrow-right-long"></i></a></li>
            </ul>
          </div>
          <div class="sidebar-cta">
            <img src="https://picsum.photos/850" alt="image">
            <div class="content-inner">
              <i class="icon-solid icon-phone-volume"></i>
